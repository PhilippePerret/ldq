defmodule LdQ.Procedure do
  ...
  @doc """
  Principalement appelée par la page du contrôleur de procédure pour afficher le code HTML de la procédure.
  """
  ...
  @doc """
  Retourne l'instance de procédure d'identifiant +id+.
