...
#     phil_data = PhilHtml.to_phil(mail_path, 
#       [no_header: true, variables: variables, helpers: [LdQ.Helpers.Feminines]])
...
#       Map.merge(variables, %{user: user, user_name: user.name, user_mail: user.mail})
#     else variables end
#     # - Procédure -
