defmodule LdQWeb.CoreComponents do
  @moduledoc """
  ...
  def simple_form(assigns) do
    ...
    <.form :let={f} for={@for} as={@as} {@rest}>
      <div class="space-y-8 bg-white">
        ...
        <div :for={action <- @actions} class="right mt-2 justify-between gap-6">
  ...
  def button(assigns) do
    ...
    <button
      type={@type}
      class={[
        "phx-submit-loading:opacity-75 rounded-lg bg-green-600 hover:bg-green-800 py-2 px-6",
        "text-sm leading-8 text-white active:text-white/80",
        @class
      ]}
      {@rest}
    >
  ...
  def input(%{type: "textarea"} = assigns) do
    ...
    <div>
      ...
      <textarea
        ...
        name={@name}
        class={[
          "mt-2 block w-full rounded-lg text-zinc-900 focus:ring-0 sm:leading-6 min-h-[6rem]",
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LdQWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LdQWeb.Gettext, "errors", msg, opts)
    end
  end
